  ...
  return (
    <div className="shadow-md w-full fixed top-0 left-0">
      <div className="md:flex bg-dark flex items-center justify-between py-4 md:px-20 md:py-10 px-7 mx-auto">
        ...
        <ul
          className={`md:flex md:items-center gap-2 md:pb-0 pb-12 absolute md:static bg-off-white/5 rounded-lg md:bg-dark md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
